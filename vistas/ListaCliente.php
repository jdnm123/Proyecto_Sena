                ...
                <thead class="bg-light">
                    <tr>
                        <th>N° Documento <img src="../img/img-sistema/filtro.png" alt="icon-filtrar" loading="lazy"
                                style="width: 15px" ; /></th>
                        <th>Nombre completo<img src="../img/img-sistema/filtro.png" alt="icon-filtrar" loading="lazy"
                                style="width: 15px" ; /></th>
                        ...
                        <th>Estado<img src="../img/img-sistema/filtro.png" alt="icon-filtrar" loading="lazy"
                                style="width: 15px" ; /></th>
                        <th>Editar clientes <img src="../img/img-sistema/filtro.png" alt="icon-filtrar" loading="lazy"
                                style="width: 15px" ; /></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning"
                                href="http://localhost/sena/sistema%20de%20ventas%20e%20inventario/Vistas/EditarCliente.php">Editar</a>
